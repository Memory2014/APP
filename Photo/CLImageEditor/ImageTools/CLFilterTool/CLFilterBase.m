...
+ (NSDictionary*)defaultFilterInfo
{
    ...
    if(defaultFilterInfo==nil){
        ...
        @{
            ...
            @"CLDefaultFalseFilter"    : @{@"name":@"CIFalseColor",              @"title":[CLImageEditorTheme localizedString:@"CLDefaultFalseFilter_DefaultTitle" withDefault:@"False"],   @"version":@(7.0),   @"dockedNum":@(14.0)},
            
            
            //MORE
            
            //lomo nostalgia gothic sharpen elegant winered fresh romantic Halo Blues Dream Night
            @"CLDefaultlomoFilter"     : @{@"name":@"CIColorlomo",              @"title":[CLImageEditorTheme localizedString:@"CLDefaultlomoFilter" withDefault:@"lomo"],      @"version":@(7.0),   @"dockedNum":@(15.0)},
            @"CLDefaultromanticFilter": @{@"name":@"CIColorromantic",            @"title":[CLImageEditorTheme localizedString:@"CLDefaultromanticFilter" withDefault:@"romantic"],  @"version":@(7.0),   @"dockedNum":@(16.0)},
            @"CLDefaultBluesFilter"    : @{@"name":@"CIColorBlues",              @"title":[CLImageEditorTheme localizedString:@"CLDefaultBluesFilter" withDefault:@"Blues"],     @"version":@(7.0),   @"dockedNum":@(17.0)},
            @"CLDefaultDreamFilter"    : @{@"name":@"CIColorDream",              @"title":[CLImageEditorTheme localizedString:@"CLDefaultDreamFilter" withDefault:@"Dream"],     @"version":@(7.0),   @"dockedNum":@(18.0)},
            @"CLDefaultgothicFilter"    : @{@"name":@"CIColorgothic",             @"title":[CLImageEditorTheme localizedString:@"CLDefaultgothicFilter" withDefault:@"gothic"],     @"version":@(7.0),   @"dockedNum":@(19.0)},
            @"CLDefaultelegantFilter": @{@"name":@"CIColorelegant",               @"title":[CLImageEditorTheme localizedString:@"CLDefaultelegantFilter" withDefault:@"elegant"],  @"version":@(7.0),   @"dockedNum":@(20.0)},
            @"CLDefaultwineredFilter"    : @{@"name":@"CIColorwinered",            @"title":[CLImageEditorTheme localizedString:@"CLDefaultwineredFilter" withDefault:@"winered"],     @"version":@(7.0),   @"dockedNum":@(21.0)},
            
            //@"CLDefaultNightFilter"    : @{@"name":@"CIColorNight",              @"title":[CLImageEditorTheme localizedString:@"CLDefaultClampFilter_DefaultTitle" withDefault:@"Night"],     @"version":@(7.0),   @"dockedNum":@(26.0)},
            //@"CLDefaultnostalgiaFilter": @{@"name":@"CIColornostalgia",         @"title":[CLImageEditorTheme localizedString:@"CLDefaultnostalgiaFilter" withDefault:@"nostalgia"],  @"version":@(7.0),   @"dockedNum":@(16.0)},
           //@"CLDefaultsharpenFilter"     : @{@"name":@"CIColorsharpen",        @"title":[CLImageEditorTheme localizedString:@"CLDefaultCubeFilter_DefaultTitle" withDefault:@"sharpen"],      @"version":@(7.0),   @"dockedNum":@(18.0)},
            //@"CLDefaultfreshFilter"     : @{@"name":@"CIColorfresh",            @"title":[CLImageEditorTheme localizedString:@"CLDefaultCubeFilter_DefaultTitle" withDefault:@"fresh"],      @"version":@(7.0),   @"dockedNum":@(21.0)},
            //@"CLDefaultHaloFilter"    : @{@"name":@"CIColorHalo",               @"title":[CLImageEditorTheme localizedString:@"CLDefaultClampFilter_DefaultTitle" withDefault:@"Halo"],     @"version":@(7.0),   @"dockedNum":@(23.0)},
        };
    }
...
+ (UIImage*)filteredImage:(UIImage*)image withFilterName:(NSString*)filterName
{
    ...
    if([filterName isEqualToString:@"CIColorlomo"]){
        return [ZYImage imageWithImage:image withColorMatrix:colormatrix_lomo];;
    }
    if([filterName isEqualToString:@"CIColorgothic"]){
        return [ZYImage imageWithImage:image withColorMatrix:colormatrix_gothic];;
    }
    if([filterName isEqualToString:@"CIColorelegant"]){
        return [ZYImage imageWithImage:image withColorMatrix:colormatrix_elegant];;
    }
    if([filterName isEqualToString:@"CIColorwinered"]){
        return [ZYImage imageWithImage:image withColorMatrix:colormatrix_winered];;
    }
    if([filterName isEqualToString:@"CIColorromantic"]){
        return [ZYImage imageWithImage:image withColorMatrix:colormatrix_romantic];;
    }
    if([filterName isEqualToString:@"CIColorBlues"]){
        return [ZYImage imageWithImage:image withColorMatrix:colormatrix_blues];;
    }
    if([filterName isEqualToString:@"CIColorDream"]){
        return [ZYImage imageWithImage:image withColorMatrix:colormatrix_dream];;
    }
...
@interface CLDefaultFalseFilter : CLDefaultEmptyFilter
@end
@implementation CLDefaultFalseFilter
@end

@interface CLDefaultlomoFilter : CLDefaultEmptyFilter
@end
@implementation CLDefaultlomoFilter
@end

@interface CLDefaultgothicFilter : CLDefaultEmptyFilter
@end
@implementation CLDefaultgothicFilter
@end


@interface CLDefaultelegantFilter : CLDefaultEmptyFilter
@end
@implementation CLDefaultelegantFilter
@end

@interface CLDefaultwineredFilter : CLDefaultEmptyFilter
@end
@implementation CLDefaultwineredFilter
@end


@interface CLDefaultromanticFilter : CLDefaultEmptyFilter
@end
@implementation CLDefaultromanticFilter
@end


@interface CLDefaultBluesFilter : CLDefaultEmptyFilter
@end
@implementation CLDefaultBluesFilter
@end

@interface CLDefaultDreamFilter : CLDefaultEmptyFilter
@end
@implementation CLDefaultDreamFilter
@end
