...
- (void)viewDidLoad {
    ...
    //self.blurView = [[UIVisualEffectView alloc] initWithEffect:vibrancy];
    
    self.collectionView.backgroundView = self.blurView;
    //[self.collectionView.backgroundView addSubview:self.blurView];
...
- (void)setupCell {
    ...
    //self.vibrancyView = [[UIView alloc]init];
    //self.vibrancyView.backgroundColor = [UIColor clearColor];
