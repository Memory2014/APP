...
@interface ZYZoomingScrollView () {
    
	ZYTapDetectingView *_tapView;                // for background taps
	ZYTapDetectingImageView *_photoImageView;
    
    PhotoViewController __weak *_photoBrowser;
}

@end

@implementation ZYZoomingScrollView
...
- (id)initWithPhotoBrowser:(PhotoViewController *)browser{
    ...
    if ((self = [super init])) {
        ...
        _tapView = [[ZYTapDetectingView alloc] initWithFrame:self.bounds];
        _tapView.tapDelegate = self;
        _tapView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
        [self addSubview:_tapView];
        
        // Image view
        _photoImageView = [[ZYTapDetectingImageView alloc] initWithFrame:CGRectZero];
