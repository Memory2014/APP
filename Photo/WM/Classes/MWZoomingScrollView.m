...
- (id)initWithPhotoBrowser:(MWPhotoBrowser *)browser {
    if ((self = [super init])) {
		...
		_tapView.backgroundColor =  [UIColor colorWithRed:0.9255 green:0.9255 blue:0.9255 alpha:1];
        ...
        _photoImageView.backgroundColor = [UIColor colorWithRed:0.9255 green:0.9255 blue:0.9255 alpha:1];
...
- (void)handleSingleTap:(CGPoint)touchPoint {
    ...
    [UIView animateWithDuration:animationDuration animations:^(void) {
        _tapView.backgroundColor = [UIApplication sharedApplication].statusBarHidden ? [UIColor colorWithRed:0.9255 green:0.9255 blue:0.9255 alpha:1]:[UIColor blackColor];
