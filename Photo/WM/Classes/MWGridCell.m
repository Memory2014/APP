...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        _imageView.image = [UIImage imageNamed:@"cellBack.png"];
...
//        //_selectedButton.frame = _imageView.frame;
//        _selectedButton.bounds = _imageView.bounds;
...
- (void)prepareForReuse {
    _photo = nil;
    _gridController = nil;
   //_imageView.image = [UIImage imageNamed:@"back.png"];
